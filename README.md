...
- `bootstrap.css.search.card` - specifies the Bootstrap CSS classes to append to the search results card component (e.g. `theme-primary` to apply primary coloring to the card).
